...
instrument, and it prices the skew slope, not the volatility level. (2) The two wing vannas have \emph{opposite signs}, so net vanna cannot be
...
A delta-matched risk reversal has zero net vega---exactly, and for any smile.
\end{prop}
...
2.4\%). Measured across the 10-delta, 25--45-day belt the residual is 3.5\% of the differential
...
structural effect. The economically relevant statement survives all of this untouched, because it
